...
- Lanciare db_init: java -jar db_init.jar <Nome DB> <username> <password>
  ...
  Troubleshooting: Il database potrebbe non andare se si connette con JDBC per la prima volta. Quindi connettersi da PgAdmin cliccando       semplicemente sul database creato in precedenza.
